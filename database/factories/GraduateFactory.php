...
class GraduateFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'course' => $this->faker->randomElement(['Computer Science', 'Business Management', 'Accounting', 'Psychology', 
            ...
            'graduation_date' => $this->faker->dateTimeBetween('-30 years', 'now')->format('Y-m-d'),
